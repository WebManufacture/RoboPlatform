  ...
  49                     ; 10 @far @interrupt void NonHandledInterrupt (void)
  49                     ; 11 {
  50                     	switch	.text
 ...
 140  004d 00            	dc.b	page(_UART_TX_IRQHandler)
 141  004e 0000          	dc.w	_UART_TX_IRQHandler
 142  0050 82            	dc.b	130
 144  0051 00            	dc.b	page(_UART_RX_IRQHandler)
 145  0052 0000          	dc.w	_UART_RX_IRQHandler
 ...
 152  0059 00            	dc.b	page(_UART_TX_IRQHandler)
 153  005a 0000          	dc.w	_UART_TX_IRQHandler
 154  005c 82            	dc.b	130
 156  005d 00            	dc.b	page(_UART_RX_IRQHandler)
 157  005e 0000          	dc.w	_UART_RX_IRQHandler
 ...
 250                     	xdef	__vectab
 251                     	xref	_UART_RX_IRQHandler
 252                     	xref	_UART_TX_IRQHandler
 253                     	xref	__stext
 254                     	xdef	f_NonHandledInterrupt
 273                     	end
