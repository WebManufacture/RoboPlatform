...
extern void iTim2_compare();     /* startup routine */
...
struct interrupt_vector const _vectab[] = {
	...
	{0x82, (interrupt_handler_t)iTim2_compare}, /* irq14 */
	{0x82, ReservedInterrupt}, /* irq15 */
	{0x82, ReservedInterrupt}, /* irq16 */
	{0x82, (interrupt_handler_t)iUART_TX}, /* irq17 */
	{0x82, (interrupt_handler_t)iUART_RX}, /* irq18 */
	{0x82, NonHandledInterrupt}, /* irq19 I2C */
	{0x82, (interrupt_handler_t)iUART_TX}, /* irq20 */
	{0x82, (interrupt_handler_t)iUART_RX}, /* irq21 */
	{0x82, NonHandledInterruptADC}, /* irq22 */
	{0x82, (interrupt_handler_t)iTim4_OVF}, /* irq23 */
